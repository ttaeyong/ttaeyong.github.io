...
단순한 기능 구현을 넘어, 복잡한 **요구사항을 주기 태스크, 인터럽트 이벤트, 상태기계 기반 제어 로직으로 분해하여 확장 가능하고 안정적인 아키텍처로 설계**하는 데 집중했습니다.
...
기능 구현뿐 아니라, **입력 수집, 상태 판단, 디스플레이, 경고 출력을 태스크 단위로 분리하고 목적에 맞는 IPC로 연결**하는 데 집중했습니다.
